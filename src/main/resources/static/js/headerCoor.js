document.getElementById('buttonCor').addEventListener('click',
    function() {
        document.querySelector('.bg-modallC').style.display = 'flex';
    });

document.querySelector('.close').addEventListener('click',
    function() {
        document.querySelector('.bg-modallC').style.display = 'none';
    });
